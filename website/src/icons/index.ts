...
export const FigmaIcon = defineComponent({
  name: 'FigmaIcon',
  render() {
    return h('svg', { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 48 48', width: '48px', height: '48px' }, [
      h('path', { fill: '#e64a19', d: 'M26,17h-8c-3.866,0-7-3.134-7-7v0c0-3.866,3.134-7,7-7h8V17z' }),
      h('path', { fill: '#7c4dff', d: 'M25,31h-7c-3.866,0-7-3.134-7-7v0c0-3.866,3.134-7,7-7h7V31z' }),
      h('path', {
        fill: '#66bb6a',
        d: 'M18,45L18,45c-3.866,0-7-3.134-7-7v0c0-3.866,3.134-7,7-7h7v7C25,41.866,21.866,45,18,45z',
      }),
      h('path', { fill: '#ff7043', d: 'M32,17h-7V3h7c3.866,0,7,3.134,7,7v0C39,13.866,35.866,17,32,17z' }),
      h('circle', { cx: '32', cy: '24', r: '7', fill: '#29b6f6' }),
    ])
  },
})

export const RaycastIcon = defineComponent({
  name: 'RaycastIcon',
  render() {
    return h(
      'svg',
...
export const YouTubeIcon = defineComponent({
  ...
  render() {
    return h('svg', { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 48 48', width: '48px', height: '48px' }, [
      ...
      h('path', { fill: '#FFF', d: 'M20 31L20 17 32 24z' }),
    ])
  },
})

export const SlackIcon = defineComponent({
  name: 'SlackIcon',
  render() {
    return h('svg', { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 48 48', width: '48px', height: '48px' }, [
      h('path', {
        fill: '#33d375',
        d: 'M33,8c0-2.209-1.791-4-4-4s-4,1.791-4,4c0,1.254,0,9.741,0,11c0,2.209,1.791,4,4,4s4-1.791,4-4C33,17.741,33,9.254,33,8z',
      }),
      h('path', {
        fill: '#33d375',
      ...
      h('path', {
        fill: '#40c4ff',
        d: 'M8,14c-2.209,0-4,1.791-4,4s1.791,4,4,4c1.254,0,9.741,0,11,0c2.209,0,4-1.791,4-4s-1.791-4-4-4C17.741,14,9.254,14,8,14z',
      }),
      h('path', {
        fill: '#40c4ff',
      ...
      h('path', {
        fill: '#e91e63',
        d: 'M14,39.006C14,41.212,15.791,43,18,43s4-1.788,4-3.994c0-1.252,0-9.727,0-10.984c0-2.206-1.791-3.994-4-3.994s-4,1.788-4,3.994C14,29.279,14,37.754,14,39.006z',
      }),
      h('path', {
        fill: '#e91e63',
        d: 'M4,28.022c0-2.206,1.791-3.994,4-3.994c1.195,0,4,0,4,0s0,2.981,0,3.994c0,2.206-1.791,3.994-4,3.994S4,30.228,4,28.022z',
      }),
      h('path', {
        fill: '#ffc107',
        d: 'M39,33c2.209,0,4-1.791,4-4s-1.791-4-4-4c-1.254,0-9.741,0-11,0c-2.209,0-4,1.791-4,4s1.791,4,4,4C29.258,33,37.746,33,39,33z',
      }),
      h('path', {
        fill: '#ffc107',
...
export const VercelIcon = defineComponent({
  name: 'VercelIcon',
  render() {
    return h('svg', { 'aria-label': 'Vercel Logo', fill: 'var(--highContrast)', height: '26', viewBox: '0 0 75 65' }, [
      h('path', { d: 'M37.59.25l36.95 64H.64l36.95-64z' }),
    ])
  },
})
...
export const LinearIcon = defineComponent({
  ...
  props: { style: Object },
  render() {
    return h('svg', { width: '64', height: '64', viewBox: '0 0 64 64', fill: 'none', style: this.style }, [
      h('path', {
...
export const CopyIcon = defineComponent({
  name: 'CopyIcon',
  render() {
    return h('svg', { width: '16', height: '16', strokeWidth: '1.5', viewBox: '0 0 24 24', fill: 'none' }, [
      h('path', {
...
export const CopiedIcon = defineComponent({
  name: 'CopiedIcon',
  render() {
    return h('svg', { width: '16', height: '16', strokeWidth: '1.5', viewBox: '0 0 24 24', fill: 'none' }, [
      h('path', {
...
export const FramerIcon = defineComponent({
  name: 'FramerIcon',
  render() {
    return h('svg', { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 16 24' }, [
      h('path', {
...
export const VueIcon = defineComponent({
  name: 'VueIcon',
  render() {
    return h('svg', { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 261.76 226.69', width: '24', height: '24' }, [
      h('path', { d: 'M161.096.001l-30.225 52.351L100.647.001H-.005l130.877 226.688L261.749.001z', fill: '#41b883' }),
      h('path', { d: 'M161.096.001l-30.225 52.351L100.647.001H52.346l78.526 136.01L209.398.001z', fill: '#34495e' }),
    ])
  },
})
...
export const Logo = defineComponent({
  name: 'Logo',
  props: { size: { type: String, default: '20px' } },
  setup(props, { slots }) {
    return () =>
      h('div', { class: 'blur-logo', style: { width: props.size, height: props.size } }, [
        h('div', { class: 'blur-logo__bg', 'aria-hidden': 'true' }, slots.default?.()),
        h('div', { class: 'blur-logo__inner' }, slots.default?.()),
      ])
  },
})
